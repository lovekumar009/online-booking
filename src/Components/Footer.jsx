...
const Footer = () => {
  return (
    <div>
      <footer>
        <div class="max-w-screen-xl px-4 pt-16 pb-6 mx-auto lg:pt-24">
                    ...
                    <li>
                      ...
                      >
                        ...
                        <span class="relative flex w-2 h-2 -mr-2">
                          <span class="absolute inline-flex w-full h-full bg-[#8c52ff] rounded-full opacity-75 animate-ping"></span>
                          <span class="relative inline-flex w-2 h-2 bg-[#8c52ff] rounded-full"></span>
                        </span>
                      </a>
                    </li>
                  </ul>
          ...
          <div class="pt-6 mt-12 border-t border-gray-800">
            <div class="text-center sm:flex sm:justify-between sm:text-left">
              <p class="text-sm text-gray-400">
                ...
                <a
                  class="inline-block text-[#9434E6] underline transition hover:text-[#8c52ff]"
                  href="/"
                >
                  Terms & Conditions
                </a>
